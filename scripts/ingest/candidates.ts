...
export const CANDIDATES: Candidate[] = [
  ...
  { id: "ny-niagara-falls", name: "Niagara Power Reach", state: "NY", county: "Niagara", countyFips: "36063", lat: 43.0912, lng: -79.0231, iso: "NYISO", context: "NYPA Niagara hydro — some of the lowest-cost power in the eastern US.", knownZoning: "heavy_industrial" },
  { id: "ny-genesee-stamp", name: "WNY STAMP", state: "NY", county: "Genesee", countyFips: "36037", lat: 43.0803, lng: -78.3889, iso: "NYISO", context: "Science & Technology Advanced Manufacturing Park — ~1,250 shovel-ready acres with dedicated substation.", knownAcreage: 1250, knownZoning: "heavy_industrial" },
